    ...
    <div className='h-[calc(100vh-80px)] px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 flex items-center justify-center'>
       <form className='flex flex-col gap-8' onSubmit={handleSubmit}>
        ...
        ):null}
        {
          ...
          {mode === MODE.LOGIN && 
          <div className='text-sm underline cursor-pointer' onClick={() => setMode(MODE.RESET_PASSWORD)}>Forget password</div>}

           <button className='bg-[#f35c7a] text-white p-2 rounded-md disabled:bg-pink-200 
